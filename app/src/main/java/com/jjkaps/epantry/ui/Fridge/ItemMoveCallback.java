...
public class ItemMoveCallback extends ItemTouchHelper.Callback {
    ...
    public int getMovementFlags(RecyclerView recyclerView, RecyclerView.ViewHolder viewHolder) {
        int dragFlags = ItemTouchHelper.UP | ItemTouchHelper.DOWN | ItemTouchHelper.UP | ItemTouchHelper.DOWN;
    ...
    public void onSelectedChanged(RecyclerView.ViewHolder viewHolder,
        ...
        if (actionState != ItemTouchHelper.ACTION_STATE_IDLE) {
            if (viewHolder instanceof ItemAdapter.ItemViewHolder) {
                ItemAdapter.ItemViewHolder myViewHolder=
                        (ItemAdapter.ItemViewHolder) viewHolder;
